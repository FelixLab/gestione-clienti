      ...
      foreach($interventi as $app) {
        ...
        if($giornoattuale != $giornoprecedente) {
          ...
          if(date("Y-m-d")==$giornoattuale) { 
            echo "<!-- GIORNO --><div class='row'><div class='col-lg-12'><h2 class='bg-primary' style='text-align:left;text-transform: Capitalize;font-size:x-large;'>$app->giornosettimana $giornoattuale - OGGI</h2></div></div>"; 
          } else {
            echo "<!-- GIORNO --><div class='row'><div class='col-lg-12'><h2 style='text-align:left;text-transform: Capitalize;font-size:x-large;'>$app->giornosettimana $giornoattuale</h2></div></div>"; 
          }
        ...
        foreach($interventi as $app) {
          ...
          if($app->data == $giornoattuale) {
              ...
              if($app->eseguito==1){
                $executed = "<a class='btn btn-xs btn-success'><i class='fa fa-thumbs-up'></i></a>";
              }else{
                $executed = "<a class='btn btn-xs btn-danger'><i class='fa fa-thumbs-down'></i></a>";
              }
