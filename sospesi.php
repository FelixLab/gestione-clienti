...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="" style="text-align: center;">
        <h2 class="corsivo" style="text-align: center; font-weight: BOLD;">Manutenzioni IN SOSPESO da rinnovare
        <br/>
        <br/>
        <ul class="nav nav-pills ">
          <li>
            <a href="/gestione-clienti/manutenzioni.php" style='color:#2BBBAD;'  >Tutti</a>
          </li>
          <li class="active">
              <a style='background-color:#2BBBAD;'>Sospesi</a>
          </li>
        </ul>
