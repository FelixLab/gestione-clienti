...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <ul class="nav nav-pills ">
          ...
          <li><a href='/gestione-clienti/domani.php' style='color:#0275d8;'>Domani</a></li>
          <li class="active">
              <a style='background-color:#0275d8;'>Dopo Domani</a>
          </li>
        </ul>    
      ...
      try {
        ...
        if ($userRow['isAdmin'] == '1') {
                  ...
                  and STR_TO_DATE(i.data,'%d/%m/%Y') = DATE_ADD(CURDATE(), INTERVAL 2 DAY) and (eseguito=0 OR eseguito is NULL)
      ...
      if(count($interventi)==0){
        echo "<!-- GIORNO --><div class='row'><div class='col-lg-12'><h2 class='bg-primary' style='text-align:center;text-transform: Capitalize;font-size:x-large;background-color:#3F729B;' >Dopo Domani -  Nessuna Pianificazione</h2></div></div>";
      }
      ...
      foreach($interventi as $app) {
        ...
        if($giornoattuale != $giornoprecedente) {
          ...
          //echo date("d-m-Y"); 
            ...
            echo "<!-- GIORNO --><div class='row'><div class='col-lg-12'><h2 class='bg-primary' style='text-align:center;text-transform: Capitalize;font-size:x-large;background-color:#3F729B;' >Dopo Domani -  $app->giornosettimana $dataFormatoIT</h2></div></div>"; 
        ...
        foreach($interventi as $app) {
          ...
          if($app->eseguito==1){
            ...
            $executed = "<a class='btn btn-danger' href='eseguito.php?id_intervento=".$app->id_intervento."&execute=1&day=2' onclick='execute(event);'><i class='fa fa-check-square' style='font-size: 2em;'></i></a>";
          }
