...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="" style="text-align: center;">
      ...
      <ul class="nav nav-pills ">
          <li class="active" >
            <a href="#" style='background-color:#0275d8;'>Oggi</a>
          </li>
      ...
      foreach($interventi as $app) {
        ...
        foreach($interventi as $app) {
          ...
          if($app->eseguito==1){
            ...
            $executed = "<a class='btn btn-danger' href='eseguito.php?id_intervento=".$app->id_intervento."&execute=1&day=0' onclick='execute(event);'><i class='fa fa-check-square' style='font-size: 2em;'></i></a>";
          }
